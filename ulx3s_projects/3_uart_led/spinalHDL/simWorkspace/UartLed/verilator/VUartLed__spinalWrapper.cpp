...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new CDataSignalAccess(&(top.io_ledData));
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/moss/Documents/vdfs-in-hardware/implementations/ulx3s_projects/3_uart_led/spinalHDL/./simWorkspace/UartLed/") + name + ".vcd").c_str());
      #endif
    }
