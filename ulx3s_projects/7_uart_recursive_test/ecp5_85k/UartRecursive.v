...
module UartFsmInOut (
      ...
      output reg [511:0] io_toFnct_payload,
      input   io_fromFnct_valid,
      input  [511:0] io_fromFnct_payload,
      input   clk,
      input   reset);
  wire [2:0] _zz_3_;
  ...
  reg [511:0] fsmIn_buffer;
  wire  fsmOut_wantExit;
  reg [5:0] fsmOut_outCounter;
  reg [511:0] fsmOut_outBuffer;
  ...
  always @ (*) begin
    io_toFnct_payload = (512');
    case(fsmIn_stateReg)
  ...
  always @ (*) begin
    ...
    case(fsmIn_stateReg)
      ...
      `fsmIn_enumDefinition_defaultEncoding_fsmIn_inIncCounter : begin
        if((fsmIn_inCounter == (6'b111111)))begin
  ...
  always @ (*) begin
    ...
    case(fsmOut_stateReg)
      ...
      `fsmOut_enumDefinition_defaultEncoding_fsmOut_outIncCounter : begin
        if((fsmOut_outCounter == (6'b111111)))begin
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      fsmIn_buffer <= (512');
      fsmOut_outCounter <= (6'b000000);
      fsmOut_outBuffer <= (512');
      ...
      case(fsmOut_stateReg)
        ...
        `fsmOut_enumDefinition_defaultEncoding_fsmOut_outIncCounter : begin
          fsmOut_outCounter <= (fsmOut_outCounter + (6'b000001));
        end
        default : begin
        end
      endcase
...
module Square (
      ...
      input  [511:0] io_fromUart_payload,
      output reg  io_toUart_valid,
      output reg [511:0] io_toUart_payload,
      input   clk,
      input   reset);
  wire [511:0] _zz_10_;
  wire [511:0] _zz_11_;
  ...
  wire [511:0] _zz_27_;
  wire  fsm_wantExit;
  reg [511:0] fsm_buffer;
  reg [511:0] fsm_result;
  ...
  assign _zz_10_ = (_zz_11_ + _zz_26_);
  assign _zz_11_ = (_zz_12_ - _zz_25_);
  assign _zz_12_ = (_zz_13_ + _zz_24_);
  assign _zz_13_ = (_zz_14_ - _zz_23_);
  assign _zz_14_ = (_zz_15_ + _zz_22_);
  assign _zz_15_ = (_zz_16_ - _zz_21_);
  assign _zz_16_ = (_zz_17_ + _zz_20_);
  assign _zz_17_ = (_zz_18_ * _zz_19_);
  assign _zz_18_ = (_zz_7_ / (2'b10));
  assign _zz_19_ = (_zz_8_ / (2'b10));
  assign _zz_20_ = {256'd0, _zz_7_};
  assign _zz_21_ = {256'd0, _zz_8_};
  assign _zz_22_ = {256'd0, _zz_5_};
  assign _zz_23_ = {256'd0, _zz_6_};
  assign _zz_24_ = {256'd0, _zz_3_};
  assign _zz_25_ = {256'd0, _zz_4_};
  assign _zz_26_ = {256'd0, _zz_1_};
  assign _zz_27_ = {256'd0, _zz_2_};
  `ifndef SYNTHESIS
  always @(*) begin
    case(fsm_stateReg)
  ...
  always @ (*) begin
    io_toUart_payload = (512');
    case(fsm_stateReg)
  ...
  assign _zz_1_ = fsm_buffer[255 : 0];
  assign _zz_2_ = fsm_buffer[511 : 256];
  assign _zz_3_ = (_zz_1_ / (2'b10));
  assign _zz_4_ = (_zz_2_ / (2'b10));
  assign _zz_5_ = (_zz_3_ / (2'b10));
  assign _zz_6_ = (_zz_4_ / (2'b10));
  assign _zz_7_ = (_zz_5_ / (2'b10));
  assign _zz_8_ = (_zz_6_ / (2'b10));
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      fsm_buffer <= (512');
...
module UartRecursive (
  ...
  wire [511:0] uartfsm_io_toFnct_payload;
  wire  square_1__io_toUart_valid;
  wire [511:0] square_1__io_toUart_payload;
