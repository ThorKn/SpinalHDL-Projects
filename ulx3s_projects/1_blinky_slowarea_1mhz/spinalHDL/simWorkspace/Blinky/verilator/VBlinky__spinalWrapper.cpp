...
public:
    ...
    Wrapper_1(const char * name){
      time = 0;
      signalAccess[0] = new CDataSignalAccess(&(top.io_led));
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/moss/Documents/vdfs-in-hardware/implementations/ulx3s_projects/1_blinky/spinalHDL/./simWorkspace/Blinky/") + name + ".vcd").c_str());
      #endif
    }
