...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new CDataSignalAccess(&(top.clkIsLocked));
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/moss/Documents/vdfs-in-hardware/implementations/ulx3s_projects/13_uart_mod_full_pll/spinalHDL/./simWorkspace/UartMod/") + name + ".vcd").c_str());
      #endif
    }
