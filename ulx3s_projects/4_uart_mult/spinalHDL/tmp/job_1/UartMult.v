...
module UartFsmInOut (
  ...
  reg [47:0] fsmIn_buffer;
  wire  fsmOut_wantExit;
  reg [2:0] fsmOut_outCounter;
  reg [47:0] fsmOut_outBuffer;
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      fsmIn_buffer <= (48'b000000000000000000000000000000000000000000000000);
      fsmOut_outCounter <= (3'b000);
      fsmOut_outBuffer <= (48'b000000000000000000000000000000000000000000000000);
...
module Mult (
      ...
      output reg [47:0] io_toUart_payload,
      input   clk,
      input   reset);
  wire  fsm_wantExit;
  reg [47:0] fsm_buffer;
  ...
  always @ (*) begin
    io_toUart_payload = (48'b000000000000000000000000000000000000000000000000);
    case(fsm_stateReg)
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      fsm_buffer <= (48'b000000000000000000000000000000000000000000000000);
      fsm_result <= (48'b000000000000000000000000000000000000000000000000);
      ...
      case(fsm_stateReg)
        ...
        `fsm_enumDefinition_defaultEncoding_fsm_stateB : begin
          fsm_result <= (fsm_buffer[23 : 0] * fsm_buffer[47 : 24]);
        end
        `fsm_enumDefinition_defaultEncoding_fsm_stateC : begin
        end
        default : begin
...
module UartMult (
  ...
  wire [47:0] mult_1__io_toUart_payload;
